...
The goal of the page is to introduce the user to document (see [Document](./project_overview.md/#argument_definition) definition) discussion process,<br>
Explain the document issues and encourage her to sign up and participate.
#### 3.1.1. Specification
##### 3.1.1.2. __Page Topics__
...
### 3.3. <a id="new-votes-page">New Votes Page</a>
...
#### 3.3.1. Specification
#### 3.3.1.1. <a id="page-mode">__Modes__</a>:
...
- [_Bread Crumbs_](#bread-crumbs)
#### 3.3.2. __Mockups__:
#### 3.2.2.1. __Mock up 1 for New Suggestion__:  
...
#### 3.2.2.2. __Mock Up 2 for New Suggestion__:
...
#### 3.2.2.3. __Mock up 1 for Editing Suggestion__:
...
#### 3.2.2.4. __Mock Up 2 for Editing Suggestion__:
...
## 4.4. <a id="arguments_block">__Arguments Block__</a><br>
...
Each block is composed from 4 elements:  
  ...
  - Comments List. Each comment is composed of 3 elements: 
    ...
    - [User Avatar](#user-avatar)
    - [Timestamp](#timestamp) (published)
## 4.5. <a id="suggestion-navigation-buttons">__Suggestion Navigation Buttons__</a><br>
...
There are 2 buttons:
### 4.5.1. Next Suggestion Clickable
...
### 4.5.2. Previous Suggestion Clickable
...
## 4.6. <a id="user-avatar">__User Avatar__</a><br>
...
## 4.7. <a id="user-menu">__User Menu__</a>
...
The [Vote](./project_overview.md/#vote_definition) has a mode: _Pro_ or _Con_
  ...
  The action result depend on the mode:
    ...
    - Con
      ...
      - threshold = threshold + 1
## 5.4. <a id="suggestions-progress-bar">__Suggestions Progress Bar__</a>
A Progress Bar that shows how many suggestions the user already voted and how many are left to vote.
## 5.5. <a id="get-notification">__Get Notification__</a>
...
# 6. <a id="logics">Logics</a>
The logical specifications that are used in the pages flows
## 6.1 <a id="rules">Rules</a>
### 6.1.1 <a id="user-connected-rule">__User Connected Rule__</a>
...
## 6.2<a id="algorithms"></a> Algorithms:
### 6.2.1. <a id="most-agreed-upon">__Most Agreed Upon__</a>
...
### 6.2.2. <a id="specific-topic-suggestions">__Specific Topic Suggestions__</a>
Filter of suggestions that accepts only suggestions with specific topic
#### 6.2.2.1. <a id="specific-topic-suggestions-variables">variables</a>
...
### 6.2.3. <a id="sort-by-topic">__Sort by Topic__</a>
